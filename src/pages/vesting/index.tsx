...
export default function Vesting() {
  ...
  return (
    <Container id="vesting-page" className="py-4 md:py-8 lg:py-12 m-auto w-full max-w-[900px]">
      <Head>
        <title>Vesting | Orders.Cash</title>
        <meta key="description" name="description" content="TANGOswap vesting..." />
      </Head>
      <div className="flex px-0 sm:px-4 md:flex-row md:space-x-10 lg:space-x-20 md:px-10">
        ...
        <div className="flex flex-col gap-3 max-w-[400px]">
          <div className="relative w-full overflow-hidden rounded bg-dark-900">
            <div className="flex flex-col gap-3 p-4">
              <div className="flex flex-row justify-between">
                <div className="font-bold text-white">{i18n._(t`Your Claimable TANGO this Week`)}</div>
                <QuestionHelper text="Your Vested TANGO will be released each week for the next 6 months. The amount released each week is determined by your historical farming rewards. You do not need to harvest each week as unclaimed amounts from each week will continue to accrue onto the next." />
              </div>
              ...
              <div className="flex flex-col items-baseline">
                ...
                {account ? (
                  <div className="text-sm text-secondary">
                    {totalLocked ? (
                      i18n._(t`Historical Total Locked: ${formatNumber(totalLocked)} TANGO`)
                    ) : (
              ...
              >
                {pendingTreasurySignature ? (
                  ...
                  <> {claimConfirmed ? i18n._(t`Claimed`) : i18n._(t`Claim TANGO`)}</>
                )}
          ...
          <div className="relative w-full overflow-hidden rounded bg-dark-900">
            <div className="flex flex-col gap-3 p-4">
              <div className="font-bold text-white">{i18n._(t`Things you can do with your TANGO`)}</div>
              <div className="p-4 rounded bg-dark-800">
                <Link href="/stake">
                  <a className="flex items-center justify-between gap-3">
                    <div className="flex flex-col gap-1">
                      <div className="font-bold text-white">{i18n._(t`Stake TANGO for xTANGO`)}</div>
                      <div className="text-sm text-secondary">
                        {t`Gain governance rights with xTANGO and earn 5% APR (0.05% of
                ...
                <Link href={`/saave`}>
                  <a className="flex items-center justify-between gap-3">
                    <div className="flex flex-col gap-1">
                      ...
                      <div className="text-sm text-secondary">
                        {t`Stake into xTANGO add collateral as axTANGO on Aave all in
                                                            one click`}
                      </div>
                    </div>
                    <div className="min-w-[32px]">
              ...
              <div className="p-4 rounded bg-dark-800">
                <div className="flex flex-col gap-1">
                  <div className="font-bold text-white">{i18n._(t`Deposit TANGO into BentoBox`)}</div>
                  <div className="text-sm text-secondary">
