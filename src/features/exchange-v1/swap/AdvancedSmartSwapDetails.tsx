  ...
  return !trade ? null : (
    <div className="flex flex-col space-y-2">
      <RowBetween>
        ...
        <RowFixed>
          <div className="text-sm font-bold text-high-emphesis">{`${steps} step${steps > 1 ? 's' : ''}`}</div>
        </RowFixed>
      ...
      <RowBetween>
        <RowFixed>
          <div className="text-sm text-secondary">{i18n._(t`Minimum received`)}</div>
          <QuestionHelper
            text={i18n._(
        ...
        <RowFixed>
          <div className="text-sm font-bold text-high-emphesis">
            {`${trade.minimumAmountOut(allowedSlippage, feePercent).toSignificant(6)} ${
      ...
      <RowBetween>
        <RowFixed>
          <div className="text-sm text-secondary">{i18n._(t`Orders.Cash fee`)}</div>
          <QuestionHelper text={i18n._(t`Orders.Cash fee...`)} />
        </RowFixed>
